...
# Task 4 accepts an optional registration photo either as an HTTPS link or as the selected image
# itself. Keeping this compatibility type here means an early API client does not lose a valid
# photo when it later moves to the final platform.
