...
PersonName = Annotated[str, StringConstraints(min_length=1, max_length=60)]
CountryCode = Annotated[str, StringConstraints(pattern=r"^[A-Z]{2}$")]


class RegistrationProfile(ApiModel):
    """The professional details collected by Task 4 registration, kept compatible here."""
    ...
    company_name: Annotated[str, StringConstraints(min_length=1, max_length=120)] | None = None
    job_title: Annotated[str, StringConstraints(min_length=1, max_length=100)] | None = None
    country: CountryCode
    city: Annotated[str, StringConstraints(min_length=1, max_length=80)] | None = None
    time_zone: Annotated[str, StringConstraints(min_length=1, max_length=64)]
    terms_accepted: bool
    age_confirmed: bool
...
class UserCreate(ApiModel):
    # `name` remains accepted for existing Task 2 clients. New registrations supply the two
    # names and profile, matching Task 4; the route composes the legacy display name.
